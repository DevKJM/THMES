var BrowserPrint = function () {
    ...
    function h(a, d, c, b) {
        ...
        d.onreadystatechange = function () {
            ...
            d.readyState === d.DONE && 200 === d.status ? c(d.responseText) : d.readyState === d.DONE && (b ? b(d.responseText) : console.log("error occurred with no errorCallback set."))
        };
        return d
    }
    var e = {},
        ...
        b && (finishedFunction = function (b) {
            ...
            for (var d in response)
                if (response.hasOwnProperty(d) && response[d].constructor === Array)
                    for (arr = response[d], b = 0; b < arr.length; ++b) arr[b] = new e.Device(arr[b]);
